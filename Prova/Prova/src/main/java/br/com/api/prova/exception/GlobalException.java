...
public class GlobalException extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> pessoasErrorException(PessoasException e,  HttpServletRequest request) {
        return new ResponseEntity<>(getMap(e.getMessage()), HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(EntidadePessoasException.class)
    public ResponseEntity<Object> entidadeErrorException(PessoasException e,  HttpServletRequest request) {
        return new ResponseEntity<>(getMap(e.getMessage()), HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(TarefasException.class)
    public ResponseEntity<Object> tarefasErrorException(TarefasException e, HttpServletRequest request) {
        return new ResponseEntity<>(getMap(e.getMessage()), HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(EntidadeTarefaException.class)
    public ResponseEntity<Object> entidadeErrorException(EntidadeTarefaException e,  HttpServletRequest request) {
        return new ResponseEntity<>(getMap(e.getMessage()), HttpStatus.NOT_FOUND);
    }
